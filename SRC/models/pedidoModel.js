...
const pedidoModel = {
    ...
    inserirPedido: async (idCliente, dataPedido, statusPagamento,{itens}) => {
        // {itens} realiza a desastruração do objeto itens.
        ...
        try {
            ...
            await transaction.commit(); //Comfirma a trasação (salva no banco)

        } catch (error) {
            await transaction.rollback(); // Defaz tudo caso um erro
